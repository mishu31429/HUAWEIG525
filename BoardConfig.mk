...
#-include vendor/huawei/g525_U00/BoardConfigVendor.mk
...
TARGET_SPECIFIC_HEADER_PATH := device/huawei/g525_U00/include
...
TARGET_CPU_SMP := true
TARGET_BOOTLOADER_BOARD_NAME := g525_U00
#TARGET_OTA_ASSERT_DEVICE := g525,hwg525
...
BOARD_BLUETOOTH_BDROID_BUILDCFG_INCLUDE_DIR := device/huawei/g525_U00/bluetooth
...
BOARD_EGL_CFG := device/huawei/g525_U00/configs/egl.cfg
...
# Hardware
BOARD_HARDWARE_CLASS := device/huawei/g525_U00/cmhw

# Kernel
BOARD_KERNEL_BASE := 0x00200000
BOARD_KERNEL_CMDLINE := androidboot.hardware=huawei androidboot.selinux=permissive
BOARD_PAGE_SIZE := 2048
TARGET_KERNEL_CONFIG := g525u_Lucky_defconfig
...
# Recovery
BOARD_CUSTOM_GRAPHICS := ../../../device/huawei/g525_U00/recovery/graphics.c
TARGET_RECOVERY_FSTAB := device/huawei/g525_U00/rootdir/fstab.huawei
...
TARGET_RECOVERY_INITRC := device/huawei/g525_U00/recovery/init.rc
BOARD_CUSTOM_RECOVERY_KEYMAPPING := ../../device/huawei/g525_U00/recovery/recovery-keys.c


# RIL
BOARD_RIL_CLASS := ../../../device/huawei/g525_U00/ril/

#TARGET_PROVIDES_LIBRIL := true
#BOARD_PROVIDES_LIBRIL := true

# SELinux
BOARD_SEPOLICY_DIRS += device/huawei/g525_U00/sepolicy
...
TARGET_CUSTOM_WIFI := ../../device/huawei/g525_U00/libhardware_legacy/wifi/wifi.c
